...
- [ ] **3-min demo video** — script: [`submission/DEMO-TALKING-POINTS.md`](submission/DEMO-TALKING-POINTS.md)
- [ ] **Cloud Trace screenshot** — one live turn, filter `buddy_live.turn` ([`submission/JUDGE-TOOLKIT.md`](submission/JUDGE-TOOLKIT.md))
- [ ] Skim [`submission/DEMO-TALKING-POINTS.md`](submission/DEMO-TALKING-POINTS.md) before filming
