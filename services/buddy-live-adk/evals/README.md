...
| `environment_simulation.py` | Mock/injection configs for all 12 tools. Exports `happy_path_config()` and `failure_config()`. |
| `conversation_scenarios.json` | 5 user-simulation scenarios with personas + conversation plans. |
